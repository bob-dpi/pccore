...
//    cd PCCore/src
//    vi perilist # make sure the first peripheral is 'bb4io'
//    cd testbench
//    make mainbb4io_tb.xt2
//    gtkwave -a mainbb4io_tb.gtkw
//
...
module mainbb4io_tb();
    ...
    reg   [3:0] inpins;    // Values at bb4io input pins
    ...
    initial
    begin
        $dumpfile ("mainbb4io_tb.xt2");
        $dumpvars (0, mainbb4io_tb);
